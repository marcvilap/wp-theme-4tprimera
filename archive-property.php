...
$args = array(
    'post_type'      => 'property', // Asegúrate de que este es el tipo correcto de post
    'posts_per_page' => 10,         // Número de posts por página
    'paged'          => $paged,     // Página actual en la paginación
    'meta_query'     => array(
        array(
            'key'     => 'visible',
            'value'   => true,      // Verifica el tipo de dato guardado en ACF y ajusta si es necesario
            'compare' => '='
        ),
    ),
);
            ...
            <div class="grid gap-8">
                ...
                <article data-effect="fade-up" class="bg-white grid lg:grid-cols-2">
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-4 font-bold text-bronze-400 font-serif text-3xl"><?php the_field('price'); ?>
                        </div>
